...
O \textit{dataset} construído para este trabalho, a partir dos registros de vídeo das reuniões do Tribunal Regional Eleitoral do Ceará, disponibilizados em sua página oficial, teve como objetivo subsidiar o processo de desenvolvimento e validação dos métodos de inferência apresentados na seção de Metodologia, além de servir como conjunto de dados de entrada para a solução final, permitindo a avaliação de sua efetividade.

Esse conjunto de dados emparelhados mostrou-se indispensável não apenas para a validação da aplicação final e a mensuração de seu desempenho, mas também para a definição e o refinamento do fluxo do sistema em suas diferentes etapas de processamento. A utilização de dados reais, que refletem o ambiente efetivo de implantação da solução, possibilitou o ajuste mais preciso dos módulos de aquisição, pré-processamento e análise, conferindo maior robustez e representatividade aos experimentos realizados.
