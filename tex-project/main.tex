...
\lstset{
    ...
    breaklines=true,                 % Força a quebra de linha
    breakatwhitespace=false,         % Quebra mesmo sem espaço (evita vazamento)
    extendedchars=true,
    inputencoding=utf8,
...
\autor{Henrique Façanha Dutra}
\titulo{Automação do processo de confecção de atas de reunião com LLM's de código aberto: um estudo no contexto jurídico.}
\data{2025}
...
\orientador{Prof.ª Doutora Juliana Martins de Oliveira}
...
\membrodabancadois{Prof. Me. Ronaldo Pinheiro Gonçalves Junior}
\membrodabancadoiscentro{Centro de Ciências e Tecnologia - CCT}
\membrodabancadoisies{Universidade de Fortaleza - UNIFOR}

\membrodabancatres{Prof. Me. André Wescley Oliveira de Aguiar}
\membrodabancatrescentro{Centro de Ciências e Tecnologia - CCT}
\membrodabancatresies{Universidade de Fortaleza - UNIFOR}
...
\begin{document}
	...
	\imprimiranexos
		...
		\input{elementos-pos-textuais/anexos/prompt-single-shot}
		\input{elementos-pos-textuais/anexos/prompt-map-reduce}
		\input{elementos-pos-textuais/anexos/prompt-mult-map-reduce}
		\input{elementos-pos-textuais/anexos/sinteses-resultados}
		\input{elementos-pos-textuais/anexos/ata-original}
		\input{elementos-pos-textuais/anexos/modelos-pydantic}
		\input{elementos-pos-textuais/anexos/prompt-llm-as-a-judge}

		\input{elementos-pos-textuais/anexos/ata-reuniao-fonte}
	\imprimirindice
