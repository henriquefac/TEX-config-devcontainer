...
Nessa estratégia, a fase de Map é composta por múltiplos agentes 
...
Na fase de Reduce, os resultados parciais de cada agente são consolidados 
...
Se abstenha de gerar textos explicativos ou interlocução com o usuário.
...
Sua tarefa é somente listar cada pauta mencionada no segmento e, quando possível, 
...
Sua tarefa somente é identificar os temas e apresentar uma breve descrição que represente
...
Sua tarefa é somente identificar as ações deliberadas, o tema relacionado e, sempre que 
...
6. Se abstenha de gerar textos explicativos ou interlocução com o usuário.
